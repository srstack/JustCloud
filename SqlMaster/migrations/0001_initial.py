# Generated by Django 2.1.5 on 2019-01-21 15:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.CharField(default='Jinger', max_length=8, verbose_name='系统平台')),
                ('type', models.CharField(max_length=100, verbose_name='数据模板')),
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('domain', models.ForeignKey(on_delete='CASCADE', related_name='system', to='SqlMaster.Domain', verbose_name='所属域')),
            ],
        ),
        migrations.CreateModel(
            name='Users',
